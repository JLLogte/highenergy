  ...
  class Plugin
    ...
    class Particle
      ...
      spawn_particle: ->
        ...
        # Font offset not currently used since I think the small size looks better.
        ...
        $particle.css
          ...
          fontSize: @options.particle_base_font_size
          color:    random_color
        ...
        $particle.animate
          ...
          fontSize: @options.particle_font_size # Ending size, gathered from the target's font-size.
